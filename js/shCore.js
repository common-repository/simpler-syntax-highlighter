...
var dp = {
	sh :
	{
		...
		Brushes	: {},
		Strings : {
			AboutDialog : '<html><head><title>About...</title></head><body class="dp-about"><table cellspacing="0"><tr><td><p class="title">Simpler Syntax Highlighter</p><p class="para">Version: 1.0.2</p><p><a href="https://goo.gl/LUo8M2" target="_blank">https://www.petrichorpost.com</a></p>&copy; 2008 Petrichorpost.com.</td></tr><td class="copy"><p class="title">dp.SyntaxHighlighter</p><p class="para">Version: {V}</p><p><a href="https://code.google.com/archive/p/syntaxhighlighter/" target="_blank">https://code.google.com/archive/p/syntaxhighlighter</a></p>&copy; 2004-2007 Alex Gorbatchev.</td></tr><tr><td class="footer"><input type="button" class="close" value="OK" onClick="window.close()"/></td></tr></table></body></html>'
		},
		ClipboardSwf : null,
		Version : '1.5.1'
	}
...
dp.sh.Toolbar.Commands = {
	...
	About: {
		...
		{
			var wnd	= window.open('', '_blank', 'dialog,width=320,height=230,scrollbars=0');
